...
private:
	...
	void createGraphicsPipeline() {
		...
		std::string vsSource = ToSpirv_GetShaderSource(ToSpirv_GetDataPath() + "/assert/" + "shader_textures.vert");
		std::string fsSource = ToSpirv_GetShaderSource(ToSpirv_GetDataPath() + "/assert/" + "shader_textures.frag");
	...
	void createTextureImage() {
		std::string TEXTURE_PATH = ToSpirv_GetDataPath() + "/assert/obj/" + "chalet.jpg";
	...
	void loadModel() {
		...
		std::string MODEL_PATH = ToSpirv_GetDataPath() + "/assert/obj/" + "chalet.obj";
